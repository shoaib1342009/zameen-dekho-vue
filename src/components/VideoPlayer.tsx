    ...
    <div className="absolute inset-0 bg-black">
      ...
      <div className="w-full h-full relative">
        ...
        <div className="absolute bottom-20 left-1/2 -translate-x-1/2 flex flex-col items-center space-y-3">
          <button className="px-6 py-3 bg-white/20 backdrop-blur-sm text-white rounded-full font-medium tap-scale">
            View Details
          </button>
          
          <button
            onClick={onContactSeller}
            className="px-6 py-3 bg-zameen-gradient text-white rounded-full font-medium tap-scale"
          >
            Contact Seller
          </button>
          ...
          <button
            onClick={onWhatsApp}
            className="p-4 bg-zameen-whatsapp rounded-full tap-scale"
          >
